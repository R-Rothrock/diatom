...
void debug(char *msg) { printf(DEBUG, get_formatted_time(), msg); }

void info(char *msg) { printf(INFO, get_formatted_time(), msg); }

void warning(char *msg) { printf(WARNING, get_formatted_time(), msg); }

void critical(char *msg) { printf(CRITICAL, get_formatted_time(), msg); }

void error(char *msg) { printf(ERROR, get_formatted_time(), msg); }
